...
%%
function Mean= index_return(logretn,shift,epoch,Fr)
r1=shift*(Fr-1)+1;
r2=shift*(Fr-1)+epoch;
Mean=mean2(corrcoef(logretn(r1,r2,:)));
end
...
%%
function risk1=portfolio_optimization(data_retn,symbol,shift,epoch,Fr)
r1=shift*(Fr-1)+1;
r2=shift*(Fr-1)+epoch;
dailyReturn = data_retn(r1:r2,:);
